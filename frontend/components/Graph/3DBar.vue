<template>
	<div>
		...
		<v-chart ref="bar-3d-chart" :loading="false" :option="options" class="chart" />
	</div>
</template>
...
use([TooltipComponent, VisualMapComponent, Grid3DComponent, Bar3DChart, CanvasRenderer])
...
export default {
	...
	methods: {
		FillChart() {
			...
			this.options.xAxis3D.data = hours
			this.options.yAxis3D.data = days
			this.options.series = [
				{
					type: 'bar3D',
